...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeethereumcashAmount"))
        settings.setValue("nAnonymizeethereumcashAmount", 1000);
    nAnonymizeethereumcashAmount = settings.value("nAnonymizeethereumcashAmount").toLongLong();
    if (settings.contains("nDarksendRounds"))
        SoftSetArg("-darksendrounds", settings.value("nDarksendRounds").toString().toStdString());
    if (settings.contains("nAnonymizeethereumcashAmount"))
        SoftSetArg("-anonymizetraveamount", settings.value("nAnonymizeethereumcashAmount").toString().toStdString());
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AnonymizeethereumcashAmount:
            return QVariant(nAnonymizeethereumcashAmount);
        case UseBlackTheme:
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case AnonymizeethereumcashAmount:
            nAnonymizeethereumcashAmount = value.toInt();
            settings.setValue("nAnonymizeethereumcashAmount", nAnonymizeethereumcashAmount);
            emit AnonymizeethereumcashAmountChanged(nAnonymizeethereumcashAmount);
            break;
        default:
            break;
        }
