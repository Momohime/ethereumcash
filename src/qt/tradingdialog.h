...
private slots:
    ...
    QString BuyETHC(QString OrderType, double Quantity, double Rate);
    QString SellETHC(QString OrderType, double Quantity, double Rate);
