...
{
    resize(900, 520);
    setWindowTitle(tr("EthereumCash") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("ethereumcash");
    setStyleSheet("#ethereumcash { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #dedede, stop: 1 #efefef);  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a EthereumCash address"));
	...
	pioAction = new QAction(QIcon(":/icons/web"), tr("&EthereumCash Website"), this);
	pioAction->setToolTip(tr("Visit the Official EthereumCash website"));
	bitcointalkAction = new QAction(QIcon(":/icons/bitcointalk"), tr("&Bitcointalk Discussion"), this);
	bitcointalkAction->setToolTip(tr("Visit the Bitcointalk EthereumCash discussion thread"));
	chainAction = new QAction(QIcon(":/icons/slack"), tr("&EthereumCash Slack"), this);
	chainAction->setToolTip(tr("Join EthereumCash Slack"));	
	explorerAction = new QAction(QIcon(":/icons/explorer"), tr("&EthereumCash Explorer"), this);
	explorerAction->setToolTip(tr("EthereumCash Explorer"));	
    aboutAction = new QAction(tr("&About EthereumCash"), this);
    aboutAction->setToolTip(tr("Show information about EthereumCash"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for EthereumCash"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("EthereumCash client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("EthereumCash client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to EthereumCash network", "", count));
}
...
{
    QString strTitle = tr("EthereumCash") + " - ";
...
void BitcoinGUI::gotoinvestPage()
{
  investAction->setChecked(true);
	...
	if ( investtimestamp > timestamp ) { 
	 ...
	 QDesktopServices::openUrl(QUrl("https://invest.ethereumcash.io"));
	 }
	}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid EthereumCash address or malformed URI parameters."));
    }
...
{
    QDesktopServices::openUrl(QUrl("http://www.ethereumcash.io"));
}

void BitcoinGUI::bitcointalkClicked()
{
    QDesktopServices::openUrl(QUrl("https://bitcointalk.org/index.php?topic=2257032"));
}

void BitcoinGUI::chainClicked()
{
    QDesktopServices::openUrl(QUrl("https://ethereumcash.herokuapp.com/"));
}
void BitcoinGUI::explorerClicked()
{
    QDesktopServices::openUrl(QUrl("https://explorer.ethereumcash.io/"));
}
